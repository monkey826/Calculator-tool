 ...
 * This link refers to JSZip2. User is able to invoke the synchronous save and load method with JSZip2.
 * If user wants to invoke the asynchronous save and load method, he need refer the JSZip3.
 * The JSZip3 reference in the html page with the markup is like this:
 * <pre>&lt;script src="http://cdnjs.cloudflare.com/ajax/libs/jszip/3.1.3/jszip.min.js"&gt;&lt;/script&gt;</pre>
*/
declare module wijmo.xlsx {
    /**
    ...
    class Workbook implements IWorkbook {
         ...
         * This has a single parameter, the base64 string of the saved workbook.  It will be passed to user.
         * @param onError this callback user can catch error information when saving.
