...
declare module wijmo.grid.sheet {
    ...
    class FlexSheet extends FlexGrid {
         ...
         *
         * @param fileName Name of the file that will be generated.
         * @param onSaved this callback provides an approach to get the base-64 string representing the content of the saved FlexSheet.
         ...
         * This has a single parameter, the base64 string of the saved flexsheet.  It will be passed to user.
         * @param onError this callback user can catche error information when saving.
        ...
        /**
         * Loads the workbook into the <b>FlexSheet</b> asynchronously.
         * This method works with JSZip 3.0.
         *
         * @param workbook An Workbook instance or a Blob instance or a base 64 stirng or an ArrayBuffer containing xlsx file content.
