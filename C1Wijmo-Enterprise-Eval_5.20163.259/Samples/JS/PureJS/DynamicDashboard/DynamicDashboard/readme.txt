...
Note that partial views (and tiles) are somewhat limited in this version of the sample, 
since we're using plain JS and didn't want to overcomplicate the sample by adding a lot 
of template parsing code. In real scenarios, the templating would be handled by your
