Npm image for Wijmo System modules (minified)
=============================================

This folder represents an npm image containing Wijmo core and Angular 2 interop 
modules in System module format, and corresponding TypeScript definition (.d.ts) files.
...
npm install ../wijmo_download/NpmImages/wijmo-system-min
