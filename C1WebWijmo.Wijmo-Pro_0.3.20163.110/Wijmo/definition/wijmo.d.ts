...
interface JQuery {
    ...
    /** Get monthViewTitleFormat option of wijcalendar widget */
    wijcalendar(methodName: "option", optionName: "monthViewTitleFormat") ;
    /** Set monthViewTitleFormat option to wijcalendar widget */
    wijcalendar(methodName: "option", optionName: "monthViewTitleFormat", monthViewTitleFormatValue ): JQuery;
    ...
    /** Get initialView option of wijcalendar widget */
    wijcalendar(methodName: "option", optionName: "initialView") ;
    /** Set initialView option to wijcalendar widget */
    wijcalendar(methodName: "option", optionName: "initialView", initialViewValue ): JQuery;
