...
require(["wijmo.wijutil", "wijmo.wijsuperpanel", "wijmo.wijdialog", "wijmo.wijdropdown", "wijmo.wijtabs", "knockout.wijmo",
    ...
    $(function () {
        ...
        $("#lblcolophon").text("© " + new Date().getFullYear() + " GrapeCity, Inc. All Rights Reserved. All product and company names herein may be trademarks of their respective owners.");
